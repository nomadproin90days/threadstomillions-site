        ...
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 md:gap-16 items-center">
          ...
          >
            ...
            <div className="space-y-3 text-muted-foreground leading-relaxed text-[15px]">
              <p>
                In August 2024 I was trading time for money, living paycheck to paycheck. I decided enough was enough.
              </p>
              <p>
                I went all in on Threads — not with a massive following or a marketing degree, but with a strategy I built from scratch. Within weeks I left my 9-to-5. Threads is now my primary income stream, generating <span className="text-foreground font-medium">5 figures a month</span>.
              </p>
              <p>
                I built TTM because truly anyone can do this — but only with a proven blueprint. I don&apos;t gatekeep. Everything I do is in here.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-2">
              {stats.map((stat) => (
                ...
                >
                  <div className="font-heading text-xl font-bold ttm-gold-gradient-text mb-1">{stat.number}</div>
