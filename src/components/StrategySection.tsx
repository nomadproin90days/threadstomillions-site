      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {strategySteps.map((step, index) => (
            ...
            >
              <GlowingEffect proximity={64} spread={20} />
              <div className="absolute -top-6 left-8 w-12 h-12 rounded-xl bg-primary flex items-center justify-center font-display text-2xl text-primary-foreground shadow-lg shadow-primary/20 group-hover:scale-110 transition-transform duration-300 z-10">
                {step.letter}
              </div>
